...
**Purpose:** Provide a two-way full-tools build-off between architect-side and builder-side models with no merge stage, useful for comparing approaches or exploring alternatives.
