...
**Purpose:** Enable multi-subtask orchestration with dependency-aware scheduling, where a coordinator agent decomposes work and workers execute in topological order with a single fix-up pass.
