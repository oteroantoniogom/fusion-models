...
**Purpose:** Define how commands that produce more than two agent runs display live progress and final results, including stacked panels and compact widget modes.
