...
**Purpose:** Enable multi-model deliberation where an anonymous panel answers independently, rankings are aggregated via Borda count, and a chairman synthesizes consensus and split points.
